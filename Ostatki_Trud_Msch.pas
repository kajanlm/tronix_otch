...
tx:=tx+' and substr(tk.nomer,3,1)=''-'' and upper(z.zak) like (''%ÌÑ×%'') and tx.dep_dep_id=de.dep_id(+) and de.dep_dep_id=dd.dep_id(+)';
tx:=tx+' ) lk ';
...
begin
  ...
  FOstatki_Trud_Msch_TN_Cex.Caption:='Îñòàòêè òðóäî¸ìêîñòè ïî ÌÑ×: '+Form9.oraQuery1.FieldByName('name').asString;
  FOstatki_Trud_Msch_TN_Cex.Caption:=FOstatki_Trud_Msch_TN_Cex.Caption+'  ÖÅÕ='+oraQuery1.FieldByName('denomer').asString;
