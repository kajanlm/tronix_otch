...
procedure TForm73.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     OraQuery1.Close;
end;
...
procedure TForm73.DateTimePicker1Change(Sender: TObject);
begin
dn:=FormatDateTime('yyyymmdd',DateTimePicker1.DateTime);
end;

procedure TForm73.DateTimePicker2Change(Sender: TObject);
begin
dk:=FormatDateTime('yyyymmdd',DateTimePicker2.DateTime);
end;
