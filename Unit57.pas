...
//ShowMEssage(tx);
  With OraQuery1 Do
     begin
        FieldByName('ident').DisplayLAbel:='ÍÀÈÌÅÍÎÂÀÍÈÅ ';
        FieldByName('poz').DisplayLAbel:='ÅÄ.ÈÇÌ. ';
        FieldByName('podpoz').DisplayLAbel:='ÍÀÈÌÅÍÎÂÀÍÈÅ ';
        FieldByName('spname').DisplayLAbel:='ÅÄ.ÈÇÌ. ';
        FieldByName('kod').DisplayLAbel:='ÊÎÄ ';
        FieldByName('kol').DisplayLAbel:='ÈÇÃÎÒÎÂÈÒÜ ÏÎ ÒÍ ';
        FieldByName('namek').DisplayLAbel:='ÅÄ.ÈÇÌ. ';
        FieldByName('namespr').DisplayLAbel:='ÍÀÈÌÅÍÎÂÀÍÈÅ ';
     end;
