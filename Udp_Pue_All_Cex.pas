...
var
  FUdp_Pue_All_Cex: TFUdp_Pue_All_Cex;

implementation

uses Unit9, Udp_Norma_Fakt_Ostatok,Udp_Pue_All;

{$R *.dfm}

procedure TFUdp_Pue_All_Cex.FormShow(Sender: TObject);
var tx:string;
begin
//Edit1.Text:='458';
...
procedure TFUdp_Pue_All_Cex.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     OraQuery1.Close;
end;

procedure TFUdp_Pue_All_Cex.Button1Click(Sender: TObject);
var
...
procedure TFUdp_Pue_All_Cex.Button2Click(Sender: TObject);
var
...
//09.10.2019 Sheet.Range[Sheet.Cells[nk,1],Sheet.Cells[nk,7]].MergeCells:=true;
...
//09.10.2019 Sheet.Range[Sheet.Cells[nk,1],Sheet.Cells[nk,11]].MergeCells:=true;
End;

inc(nk);

Sheet.Cells[nk,1].Value:=OraQuery1.FieldByName('abrudp').asString;
Sheet.Cells[nk,2].Value:=OraQuery1.FieldByName('udp').asString;
//09.10.2019 Sheet.Range[Sheet.Cells[nk,1],Sheet.Cells[nk,11]].MergeCells:=true;
