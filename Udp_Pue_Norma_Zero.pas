...
type
  TFUdp_Pue_Norma_Zero = class(TForm)
    OraQuery1: TOraQuery;
...
var
  FUdp_Pue_Norma_Zero: TFUdp_Pue_Norma_Zero;

implementation
uses Udp_Pdo_Report,Udp_Norma_Fakt_Ostatok,Unit9;


{$R *.dfm}

procedure TFUdp_Pue_Norma_Zero.FormShow(Sender: TObject);
var tx:string;
begin
//Edit1.Text:='458';
...
procedure TFUdp_Pue_Norma_Zero.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     OraQuery1.Close;
end;

procedure TFUdp_Pue_Norma_Zero.Button1Click(Sender: TObject);
var
