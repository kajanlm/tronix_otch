...
begin
  ...
  Form68.Caption:=Form68.Caption+'  ×ÅÐÒ¨Æ='+oraQuery1.FieldByName('tynomer').asString+' Êîëè÷åñòâî='+oraQuery1.FieldByName('kol').asString+' '+oraQuery1.FieldByName('namek').asString;
  Form68.ShowModal();
  Form68.Free;
